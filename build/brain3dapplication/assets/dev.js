...
function calculateTotalAndApply() {
  var wPercentHigh =
    ((question3Score + question4Score + question8Score + question9Score) /
      weightHigh) *
    weightHigh;
  ...
  var wPercentLow =
    ((question1Score + question2Score + question6Score) / weightLow) *
    weightLow;
  var percentTotal =
    wPercentHigh + wPercentMedHigh + wPercentMed + wPercentLowMed + wPercentLow;
