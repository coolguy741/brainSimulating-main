...
Brain3DApplication.prototype = {
    ...
    // form calls this function with answer 18-95
    question1Sum: function (value) {
        this.question1Score = 13 * ((100 - (((value - 18) / 77) * 100)) / 100);
        this.calculateTotalAndApply();
    },    

    // form calls this function with answer 5-25
    question2Sum: function (value) {
        this.question3Score = 18 * ((100 - (((value - 5) / 20) * 100)) / 100);
        this.calculateTotalAndApply();
    },
